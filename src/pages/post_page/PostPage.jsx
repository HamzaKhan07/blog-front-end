...
const PostPage = () => {
    ...
    useEffect(()=>{
        ...
        fetch(`https://gray-frightened-moth.cyclic.app/posts/${id}`)
        .then(response => {
    ...
    function getUserID(){
        fetch('https://gray-frightened-moth.cyclic.app/getUserId', {
            credentials: 'include',
        }, []).then(response => {
    ...
    async function addComments(ev){
        ...
        const response = await fetch(`https://gray-frightened-moth.cyclic.app/comments/${id}`, {
            method: 'POST',
    ...
    async function deletePost(){
        ...
        if(isConfirm === true){
            //delete the post
            const response = await fetch(`https://gray-frightened-moth.cyclic.app/delete/${id}`, {
                method: 'DELETE',
            });
  ...
  return (
    <div className="postpage">
        ...
        <div class="content">
            ...
            <div className="image">
                <img src={`https://gray-frightened-moth.cyclic.app/${postInfo.cover}`} alt="postImage"/>
            </div>
